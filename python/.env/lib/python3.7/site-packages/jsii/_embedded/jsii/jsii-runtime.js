...
module.exports = JSON.parse("{\"name\":\"jsii-runtime\",\"version\":\"0.17.0\",\"description\":\"jsii runtime kernel process\",\"main\":\"lib/index.js\",\"types\":\"lib/index.d.ts\",\"bin\":{\"jsii-runtime\":\"bin/jsii-runtime\"},\"scripts\":{\"build\":\"tsc --build && chmod +x bin/jsii-runtime && /bin/bash ./bundle.sh && npm run lint\",\"watch\":\"tsc --build -w\",\"lint\":\"eslint . --ext .js,.ts --ignore-path=.gitignore\",\"test\":\"/bin/bash test/playback-test.sh && node test/stress-test.js\",\"package\":\"package-js\"},\"devDependencies\":{\"@scope/jsii-calc-base\":\"file:../jsii-calc-base\",\"@scope/jsii-calc-lib\":\"file:../jsii-calc-lib\",\"@typescript-eslint/eslint-plugin\":\"^2.3.0\",\"@typescript-eslint/parser\":\"^2.3.0\",\"eslint\":\"^6.4.0\",\"jest\":\"^24.9.0\",\"jsii-build-tools\":\"file:../jsii-build-tools\",\"jsii-calc\":\"file:../jsii-calc\",\"source-map\":\"^0.7.3\",\"source-map-loader\":\"^0.2.4\",\"typescript\":\"~3.6.3\",\"wasm-loader\":\"^1.3.0\",\"webpack\":\"^4.40.2\",\"webpack-cli\":\"^3.3.9\"},\"dependencies\":{\"jsii-kernel\":\"^0.17.0\",\"jsii-spec\":\"^0.17.0\"},\"author\":{\"name\":\"Amazon Web Services\",\"url\":\"https://aws.amazon.com\"},\"license\":\"Apache-2.0\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/aws/jsii.git\",\"directory\":\"packages/jsii-runtime\"}}");
...
function propertiesOf(t, lookup) {
    ...
    if (t.interfaces) {
        for (const iface of t.interfaces) {
            ret = Object.assign(Object.assign({}, ret), propertiesOf(lookup(iface), lookup));
        }
    }
    if (spec.isClassType(t) && t.base) {
        ret = Object.assign(Object.assign({}, ret), propertiesOf(lookup(t.base), lookup));
    }
